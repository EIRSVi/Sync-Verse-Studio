...
namespace SyncVerseStudio.Views
{
    public partial class ProductManagementView : Form
    {
        ...
        private void CreateTopPanel()
        {
            ...
            // Buttons
            int buttonX = 600;
            addButton = CreateButton("Add Product", System.Drawing.Color.FromArgb(24, 119, 18), buttonX, 45);
        ...
        private async void LoadProducts()
        {
            try
            {
                ...
                foreach (var product in products)
                {
                    ...
                    {
                        productsGrid.Rows[rowIndex].DefaultCellStyle.BackColor = System.Drawing.Color.FromArgb(255, 235, 235);
                        productsGrid.Rows[rowIndex].DefaultCellStyle.ForeColor = System.Drawing.Color.FromArgb(139, 0, 0);
                    }
                }
            }
            catch (Exception ex)
